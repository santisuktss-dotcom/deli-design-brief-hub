...
export const en: Dict = {
  ...
  worksTitle: 'Selected Works', byCat: 'Projects by category',
  ...
  approve: 'Approve', reviewApprove: 'Review & send to requester', requestRev: 'Request revision', requestCancel: 'Request cancel', requestHold: 'Request hold', submitWorkBtn: 'Submit work', noFiles: 'No files yet — upload artwork to start round one',
  ...
  editScopeTitle: 'Need to change something?',
  editScopeBtn: 'Edit category / deadline / artworks',
  editScopeHint: 'The deadline can only be moved later, not earlier. The Creative & Design Manager will be notified of any change.',
  editAssetsTitle: 'Edit category / artworks',
  editAssetsBtn: 'Edit category / artwork count',
  editAssetsHint: 'The requester will be notified of any change.',
  ...
  editBtn: 'Edit', deleteBtn: 'Delete', replaceImageBtn: 'Replace image', saveBtn: 'Save',
  confirmDeleteFile: 'Delete this?', uploadFailed: 'Image upload failed — please try again.',
};
