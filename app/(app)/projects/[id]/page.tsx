...
export default async function ProjectDetailPage({
  ...
  return (
    <div className="flex flex-col gap-8">
      <section
        className="rounded-2xl overflow-hidden relative h-[240px] flex flex-col items-center justify-center text-center p-6"
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-2 text-white">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold">{deco.title}</h1>
        </div>
      </section>
